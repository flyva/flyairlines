...
<head>
    ...
    echo $this->Html->css(array('skin-red.css','skin-red.min.css','skin-red-light.css','AdminLTE.css','AdminLTE.min.css','bootstrap.min.css','bootstrap-theme.min.css','bootstrap.css.map','bootstrap.min.css.map'));
    ...
    <link rel="stylesheet" href="../../webroot/css/skins/_all-skins.min.css">
    <!-- iCheck -->
